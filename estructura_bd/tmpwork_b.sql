...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`tmpwork_b` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
/*Table structure for table `z_cisco_sw` */

DROP TABLE IF EXISTS `z_cisco_sw`;

CREATE TABLE `z_cisco_sw` (
